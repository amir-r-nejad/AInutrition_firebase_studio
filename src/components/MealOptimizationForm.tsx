...
import { MealOptimizationRequest, RAGResponse } from '@/types/meal-optimization';
...
import { Loader2, Target, ChefHat, AlertCircle, AlertTriangle, Info } from 'lucide-react';
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="p-4 border rounded-md bg-muted/50">
            <h3 className="text-lg font-medium mb-3 text-primary">Target Macros</h3>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-md p-4">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-orange-800 mb-2">External API Unavailable</h4>
                  <p className="text-orange-700 text-sm mb-3">
                    The external Meal Optimization API is currently down. You have two options:
                  </p>
          ...
          {displayError && !showFallbackOption && (
            <div className="bg-red-50 border border-red-200 rounded-md p-4">
              ...
              <p className="text-red-600 text-sm mt-2">
                This might be due to network issues or the external API being temporarily unavailable. 
          ...
          >
            {isLoading ? (
              <>
                ...
                {useFallback ? 'Using Fallback Service...' : 'Optimizing Meal Plan...'}
              </>
            ) : (
              <>
                <Target className="mr-2 h-5 w-5" />
                {useFallback ? 'Optimize with Fallback Service' : 'Optimize Meal Plan'}
              </>
            )}
          </Button>
        </form>
